...
bibliography: 2026-01-09-moe.bib
...
toc:
  ...
  - name: "Background: Compressing MoE"
    subsections:
...
<div class="row mt-3 l-body" style="text-align: center; width: 70%; margin-left: 100px;"> 
   <div class="col-sm mt-3 mt-md-0" style="text-align: center;">
        {% include figure.liquid path="assets/img/2026-01-09-moe/moe_2022.png" class="img-fluid d-block mx-auto rounded z-depth-1" zoomable=true %}
    </div> 
</div>
...
The gating network is typically implemented as:

$$
g(\mathbf{x}) = \text{TopK} \big( \text{Softmax} ( \underbrace{\mathbf{x} \, \mathbf{W}_g^T}_{\in \mathbb{R}^{n \times N}} ) \big),
$$ 

where $\mathbf{W}_g \in \mathbb{R}^{N \times d}$ are the gating weights, and TopK is an operation that retains only the top K values per row (i.e. per token) and sets the rest to zero.
Softmax is applied along each row to produce a probability distribution over the $N$ experts.

### Expert Network Architecture

<div class="row mt-3 l-body" style="text-align: center; margin-left: 150px; width: 50%;"> 
   <div class="col-sm mt-3 mt-md-0" style="text-align: center;">
        {% include figure.liquid path="assets/img/2026-01-09-moe/glu.png" class="img-fluid d-block mx-auto rounded z-depth-1" zoomable=true %}
    </div> 
</div>
<div class="caption" style="text-align: center; margin-top: -35px; margin-bottom: 25px;">
...
<div class="row mt-3 l-body" style="text-align: center;"> 
    <div class="col-sm mt-3 mt-md-0" style="text-align: center;">
        {% include figure.liquid path="assets/img/2026-01-09-moe/scaling_upstream.png" class="img-fluid d-block mx-auto rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption" style="text-align: center; margin-top: -35px; margin-bottom: -25px;">
...
<div class="row mt-3 l-body" style="text-align: center; ">
    <div class="col-sm mt-3 mt-md-0" style="text-align: center; margin-top: -25px;">
        {% include figure.liquid path="assets/img/2026-01-09-moe/scaling_downstream.png" class="img-fluid d-block mx-auto rounded z-depth-1" zoomable=true %}
    </div> 
</div>
<div class="caption" style="text-align: center; margin-top: -35px; margin-bottom: 25px;">
...
<div class="row mt-3 l-body" style="text-align: center; margin-left: 100px; width: 70%; ">
    <div class="col-sm mt-3 mt-md-0" style="text-align: center;">
        {% include figure.liquid path="assets/img/2026-01-09-moe/kimi_k2_sparsity_scaling.png" class="img-fluid d-block mx-auto rounded z-depth-1" zoomable=true %}
    </div> 
</div>
<div class="caption" style="text-align: center; margin-top: -35px; margin-bottom: 25px;">
...
<div class="row mt-3 l-body" style="text-align: center; margin-left: 100px; width: 70%;"> 
   <div class="col-sm mt-3 mt-md-0" style="text-align: center;">
        {% include figure.liquid path="assets/img/2026-01-09-moe/pruning_vs_merging.png" class="img-fluid d-block mx-auto rounded z-depth-1" zoomable=true %}
    </div> 
</div>
<div class="caption" style="text-align: center; margin-top: -35px; margin-bottom: 25px;">
...
The following is my pseudocode of computing REAP scores based on the equation above.
```python
...
These are MoE LLMs with 30B and 235B parameters, respectively, both having $N$=128 experts and TopK=8<d-footnote>The key difference between the two models is the number of Transformer layers (48 vs 96).</d-footnote>.
...
|----------|------------|-------|-------|-------|-----------|------|------------|------|------|
| Original | 73.2       | 60.7  | 85.1  | 88.7  | 61.2      | 80.1 | 32.4       | 76.5 | 69.7 |
| REAM     | 71.8       | 51.9  | 79.1  | 88.5  | 57.6      | 70.1 | 30.0       | 77.6 | 65.8 |
...
|----------|--------|--------|-------|--------|-----------|---------------|-------|
| Original | 90.4   | 56.7   | 89.3  | 47.0   | 93.3      | 48.6          |  70.9 | 
| REAM     | 89.2   | 66.7   | 88.1  | 38.9   | 86.6      | 36.9          |  67.7 |
...
| Model    | N   | TopK | IFEval   | AIME25    | GSM8K    | HumanEval | AVG      |
|----------|-----|------|----------|-----------|----------|-----------|----------|
| Original | 128 | 8    | 93.3     | 66.7      | 89.4     | 95.1      | 86.1     |
| HC-SMoE  | 96  | 8    | 89.6     | 63.3      | 87.5     | 86.0      | 81.6     |
| REAP     | 96  | 8    | **91.6** | 66.7      | **88.3** | **95.2**  | **85.5** |
| REAM     | 96  | 8    | 90.7     | **70.0**  | 88.2     | 92.7      | 85.4     |
...
Finally, relying on calibration is generally undesirable, because the results may be sensitive to the choice of calibration data.
...
@misc{knyazev2026compressing,
  ...
  year={2026},
  howpublished={\url{https://bknyaz.github.io/2026/01/09/moe/}}
}
```