...
on multiple tasks.
- Compressed Qwen3 models are released on [huggingface](https://huggingface.co/collections/SamsungSAILMontreal/moe)🤗.
...
[huggingface-moe](https://huggingface.co/collections/SamsungSAILMontreal/moe).
