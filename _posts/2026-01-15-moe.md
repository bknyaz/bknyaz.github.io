...
on multiple tasks.
- Compressed Qwen3 models are released on [huggingface](https://huggingface.co/collections/SamsungSAILMontreal/qwen3-moe)🤗.
...
[huggingface-qwen3-moe](https://huggingface.co/collections/SamsungSAILMontreal/qwen3-moe).
...
We also plan to release the code for REAM at [SamsungSAILMontreal/ream](https://github.com/SamsungSAILMontreal/ream) in the near future.
...
@misc{knyazev2026compressing,
  ...
  year={2026},
  url={https://bknyaz.github.io/2026/01/15/moe/}
}
```